...
const projects: Project[] = [
  {
    ...
    src: "/assets/projects-screenshots/secure-chat-app.png",
    screenshots: [
      `${BASE_PATH}/secure-chat-app/1.png`,
      `${BASE_PATH}/secure-chat-app/2.png`,
    ],
    skills: {
      frontend: [
        PROJECT_SKILLS.next,
    ...
    github: "https://github.com/0xrupamp26/secure-chat-app",
    live: "https://secure-chat-app.vercel.app",
    content: function () {
      return (
        <div>
          <TypographyP className="font-mono">
            A real-time chat application with end-to-end encryption, built with Next.js and Socket.IO. Features include user authentication, private messaging, and secure message encryption.
          </TypographyP>
          <TypographyP className="font-mono mt-4">
            <strong>Key Features:</strong>
            <ul className="list-disc pl-5 mt-2">
              <li>End-to-end encryption for all messages</li>
              <li>Real-time message delivery with Socket.IO</li>
  ...
  },
  {
    ...
    src: "/assets/projects-screenshots/ecommerce.png",
    screenshots: [
      `${BASE_PATH}/ecommerce/1.png`,
      `${BASE_PATH}/ecommerce/2.png`,
    ],
    skills: {
      frontend: [
        PROJECT_SKILLS.react,
        PROJECT_SKILLS.reactQuery,  // Using reactQuery instead of redux
        PROJECT_SKILLS.tailwind,
      ],
      backend: [
        PROJECT_SKILLS.node,
    ...
    github: "https://github.com/0xrupamp26/ecommerce-platform",
    live: "https://ecommerce-rupam.vercel.app",
    content: function () {
      return (
        <div>
          <TypographyP className="font-mono">
            A full-featured e-commerce platform with product listings, cart functionality, and user authentication. Built with MERN stack (MongoDB, Express, React, Node.js).
          </TypographyP>
          <TypographyP className="font-mono mt-4">
            <strong>Key Features:</strong>
            <ul className="list-disc pl-5 mt-2">
  ...
  //             `${BASE_PATH}/codingducks/problem.png`,
  {
    ...
    skills: {
      ...
      backend: [
        PROJECT_SKILLS.node,  // Using node instead of openai
