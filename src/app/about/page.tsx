        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Rupam, a Comp. Sci. engineer with experience in development, DevOps, and
              security-focused engineering. I enjoy building scalable, secure web apps and collaborating with teams to ship
              impactful products.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, I&apos;m usually exploring new technologies, learning about security, or
              brainstorming my next project over coffee.
            </p>
