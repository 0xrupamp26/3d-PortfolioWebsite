  ...
  useEffect(() => {
    const fetchRepos = async () => {
      try {
        ...
        if (Array.isArray(data.projects)) setGithubProjects(data.projects as Project[]);
      } catch (e: any) {
  ...
  return (
    <section id="projects" className="max-w-7xl mx-auto md:h-[130vh]">
      ...
      {loading && !githubProjects.length && (
        <p className="text-center text-sm text-neutral-500 mb-4">Loading pinned projects…</p>
      )}
